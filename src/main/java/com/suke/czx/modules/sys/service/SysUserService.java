...
public interface SysUserService {
	 ...
	 * @param userId  用户ID
	 */
	List<String> queryAllPerms(BigDecimal userId);
	 ...
	 * @return
	 */
	SysUserEntity queryObject(BigDecimal userId);
	 ...
	 */
	int updatePassword(BigDecimal userId, String password, String newPassword);
}
