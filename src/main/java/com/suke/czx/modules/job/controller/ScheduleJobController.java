...
public class ScheduleJobController {
	...
	public R info(@PathVariable("jobId") BigDecimal jobId){
	...
	public R delete(@RequestBody BigDecimal[] jobIds){
	...
	public R run(@RequestBody BigDecimal[] jobIds){
	...
	public R pause(@RequestBody BigDecimal[] jobIds){
	...
	public R resume(@RequestBody BigDecimal[] jobIds){
