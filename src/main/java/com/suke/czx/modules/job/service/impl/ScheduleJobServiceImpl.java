...
public class ScheduleJobServiceImpl implements ScheduleJobService {
	...
	@Override
	public ScheduleJobEntity queryObject(BigDecimal jobId) {
	...
	@Override
	@Transactional
    public void deleteBatch(BigDecimal[] jobIds) {
    	for(BigDecimal jobId : jobIds){
	...
	@Override
    public int updateBatch(BigDecimal[] jobIds, int status){
	...
	@Override
	@Transactional
    public void run(BigDecimal[] jobIds) {
    	for(BigDecimal jobId : jobIds){
	...
	@Override
	@Transactional
    public void pause(BigDecimal[] jobIds) {
        for(BigDecimal jobId : jobIds){
	...
	@Override
	@Transactional
    public void resume(BigDecimal[] jobIds) {
    	for(BigDecimal jobId : jobIds){
