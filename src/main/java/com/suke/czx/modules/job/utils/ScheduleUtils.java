...
public class ScheduleUtils {
     ...
     * 获取触发器key
     */
    private static TriggerKey getTriggerKey(BigDecimal jobId) {
     ...
     * 获取jobKey
     */
    private static JobKey getJobKey(BigDecimal jobId) {
     ...
     * 获取表达式触发器
     */
    public static CronTrigger getCronTrigger(Scheduler scheduler, BigDecimal jobId) {
        try {
     ...
     * 暂停任务
     */
    public static void pauseJob(Scheduler scheduler, BigDecimal jobId) {
        try {
     ...
     * 恢复任务
     */
    public static void resumeJob(Scheduler scheduler, BigDecimal jobId) {
        try {
     ...
     * 删除定时任务
     */
    public static void deleteScheduleJob(Scheduler scheduler, BigDecimal jobId) {
        try {
